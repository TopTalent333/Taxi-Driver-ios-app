...
public class Details: NSObject {
    ...
    internal let kDetailsDriverCarImageKey: String = "car_image"
    ...
    public var drivercarImage: String?
    ...
    public init(json: JSON) {
        ...
        drivercarImage = json[kDetailsDriverCarImageKey].string
    ...
    public func dictionaryRepresentation() -> [String : AnyObject ] {
        ...
        if drivercarImage != nil {
            dictionary.updateValue(drivercarImage! as AnyObject, forKey: kDetailsDriverCarImageKey)
        }
